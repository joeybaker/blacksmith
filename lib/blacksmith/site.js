          ...
          markdown, 10, function renderMarkdown (file, next) {
            ...
            fs.stat(fullpath, function (err, stats) {
              ...
              content.render({
                ...
                feed.item({
                  title: results.metadata['page-details'].title, description: results.html, url: results.metadata['page-details'].href, author: results.metadata.author, date: rendered[name]._date
                })
